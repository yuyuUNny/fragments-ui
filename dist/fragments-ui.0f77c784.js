    ...
    '4f9sv': [
      function (require, module, exports, __globalThis) {
        ...
        const cognitoAuthConfig = {
          authority: `https://cognito-idp.us-east-1.amazonaws.com/${'us-east-1_EeWnhjbIl'}`,
          client_id: '7hie5mjhsa5ftpthgsh8er1lju',
        ...
        async function signOut() {
          ...
          const region = 'us-east-1_EeWnhjbIl'.split('_')[0] || 'us-east-1';
          const domainPrefix = 'fragments-ui-1757690046';
          if (!domainPrefix) {
            console.error('Missing AWS_COGNITO_DOMAIN for logout');
            return;
          }
          const logoutUrl = `https://${domainPrefix}.auth.${region}.amazoncognito.com/logout?client_id=${'7hie5mjhsa5ftpthgsh8er1lju'}&logout_uri=${encodeURIComponent('http://localhost:1234')}`;
      ...
      { 'oidc-client-ts': 'cAcxW', '@parcel/transformer-js/src/esmodule-helpers.js': 'jnFvT' },
    ],
    cAcxW: [
      function (require, module, exports, __globalThis) {
        'use strict';
        ...
        var PopupUtils = class {
           ...
           */ static center({ ...features }) {
            ...
            if (features.width == null)
              features.width =
                (_a = [800, 720, 600, 480].find((width) => width <= window.outerWidth / 1.618)) !=
                null
                  ? _a
                  : 360;
            ...
            if (features.height != null)
              (_c = features.top) != null
                ...
                : (features.top = Math.max(
                    0,
                    Math.round(window.screenY + (window.outerHeight - features.height) / 2)
                  ));
            return features;
          }
        ...
        var OidcClientSettingsStore = class {
          constructor({
            ...
            client_authentication = DefaultClientAuthentication, // optional protocol
            prompt,
            display,
            max_age,
            ui_locales,
            acr_values,
            resource,
            response_mode = DefaultResponseMode, // behavior flags
            ...
            refreshTokenAllowedScope, // extra
            extraQueryParams = {},
            extraTokenParams = {},
            extraHeaders = {},
          }) {
        ...
        var ResponseValidator = class {
          ...
          async _processClaims(response, skipUserInfo = false, validateSub = true) {
            ...
            if (validateSub && claims.sub !== response.profile.sub)
              logger2.throw(
                new Error('subject from UserInfo response does not match subject in ID Token')
              );
        ...
        var SigninResponse = class {
          ...
          get isOpenId() {
            var _a;
            return (
              ((_a = this.scope) == null ? void 0 : _a.split(' ').includes(OidcScope)) ||
              !!this.id_token
            );
          }
        };
          ...
          filterProtocolClaims(claims) {
            ...
            if (this._settings.filterProtocolClaims) {
              ...
              for (const claim of protocolClaims)
                if (!InternalRequiredProtocolClaims.includes(claim)) delete result[claim];
            }
            return result;
          }
            ...
            for (const [claim, values] of Object.entries(claims2))
              for (const value of Array.isArray(values) ? values : [values]) {
                ...
                if (previousValue === void 0) result[claim] = value;
                  ...
                  else result[claim] = [previousValue, value];
                }
              }
            return result;
          }
        ...
        var OidcClient = class {
          constructor(settings, metadataService) {
            ...
            this.metadataService =
              metadataService != null ? metadataService : new MetadataService(this.settings);
        ...
        var UserManagerSettingsStore = class extends OidcClientSettingsStore {
          constructor(args) {
            ...
            if (userStore) this.userStore = userStore;
              ...
              const store =
                typeof window !== 'undefined' ? window.sessionStorage : new InMemoryWebStorage();
        ...
        var IFrameWindow = class extends AbstractChildWindow {
          ...
          async navigate(params) {
            ...
            const timer = setTimeout(
              () => this._abort.raise(new ErrorTimeout('IFrame timed out without a response')),
        ...
        var UserManager = class {
          constructor(settings, redirectNavigator, popupNavigator, iframeNavigator) {
            ...
            this._redirectNavigator =
              redirectNavigator != null ? redirectNavigator : new RedirectNavigator(this.settings);
            this._popupNavigator =
              popupNavigator != null ? popupNavigator : new PopupNavigator(this.settings);
            this._iframeNavigator =
              iframeNavigator != null ? iframeNavigator : new IFrameNavigator(this.settings);
      ...
      {
        cd65f2846f9a9917: 'g2BaY',
        b081c80cbcca67d0: 'bHJno',
        '69a1441ed613820e': 'a3Jjc',
        '46685f198d718556': 'hwYs8',
        '3455b80cc963b26': '1Wg18',
      },
    ],
    g2BaY: [
      function (require, module, exports, __globalThis) {
               ...
               */ var BufferedBlockAlgorithm = (C_lib.BufferedBlockAlgorithm = Base.extend({
                 ...
                 */ _process: function (doFlush) {
                  ...
                  if (doFlush)
                    ...
                    nBlocksReady = Math1.ceil(nBlocksReady); // Round down to include only full blocks,
                  else
                  ...
                  if (nWordsReady) {
                    for (
                      var offset = 0;
                      offset < nWordsReady;
                      offset += blockSize // Perform concrete-algorithm logic
                    )
